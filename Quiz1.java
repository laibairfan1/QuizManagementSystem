...
import java.awt.event.*;
 class Quiz1 extends JFrame implements ActionListener {
    ...
    Quiz1(){
        setBounds(60,0,1460,500);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
     
        ImageIcon il=new ImageIcon(getClass().getResource("icons/quizes.png"));
        ...
        questions[1][0] ="Return type of hashCode() method in object class?";
        questions[1][1] ="int";
        ...
        questions[3][1] ="Runable Interface";
        ...
        questions[5][1] ="Runable Interface";
        questions[5][2] ="Remote Interface";
        questions[5][3] ="Readable Interface";
        questions[5][4] ="Result Interface";
        
        questions[6][0] ="Which keyword used for accessing the features of package?";
        ...
        questions[9][2] ="The applet makes Java code secure and portable";
